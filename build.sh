...
$CC $CFLAGS_DEBUG -L$LIB_PATH -I. project/main.cpp project/button.cpp project/movie.cpp project/interface.cpp project/rectWidget.cpp project/image.cpp -o $BIN_PATH/maind -lsggd -lGL -lGLEW -lSDL2 -lSDL2_mixer -lfreetype -lstdc++fs
